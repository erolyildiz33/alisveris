...
class Home extends CI_Controller {
    ...
    public function index(){
        ...
        $this->load->model("frontend/reference_model");
        ...
        $viewData->viewFolder   = "frontend/home_v";
    ...
    public function product_list(){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder = "frontend/product_list_v";
    ...
    public function product_detail($url = ""){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder = "frontend/product_v";

        $this->load->model("frontend/product_model");
        $this->load->model("frontend/product_image_model");
    ...
    public function portfolio_list(){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder = "frontend/portfolio_list_v";
    ...
    public function course_list(){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder = "frontend/course_list_v";
    ...
    public function course_detail($url){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder = "frontend/course_v";
    ...
    public function reference_list(){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder = "frontend/reference_list_v";
    ...
    public function brand_list(){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder = "frontend/brand_list_v";
    ...
    public function service_list(){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder = "frontend/service_list_v";
    ...
    public function about_us(){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder = "frontend/about_v";
    ...
    public function contact(){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder = "frontend/contact_v";
    ...
    public function news_list(){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder = "frontend/news_list_v";
    ...
    public function news($url){
        ...
        if($url != "") {
            ...
            $viewData = new stdClass();
            $viewData->viewFolder = "frontend/news_v";
    ...
    public function popup_never_show_again(){
        ...
        $popup_id = $this->input->post("frontend/popup_id");
    ...
    public function image_gallery_list(){
        ...
        $viewData = new stdClass();
        $viewData->viewFolder    = "frontend/galleries_v";
    ...
    public function image_gallery($gallery_url = ""){
        ...
        if($gallery_url){
            ...
            $this->load->model("frontend/image_model");
    ...
    public function file_gallery($gallery_url = ""){
        ...
        if($gallery_url){
            ...
            $this->load->model("frontend/file_model");
