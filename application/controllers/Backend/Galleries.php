...
class Galleries extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model("backend/file_model");
        ...
        if($validate){
            ...
            if($gallery_type != "video"){
                ...
                if(!mkdir($path, 0755)){
                    ...
                    redirect(base_url("backend/galerries"));
                    die();
                }
            ...
            redirect(base_url("backend/galleries"));
    ...
    public function gallery_video_save($id){
        ...
        if($validate){
            ...
            redirect(base_url("backend/galleries/gallery_video_list/$id"));
    ...
    public function gallery_video_update($id, $gallery_id){
        ...
        if($validate){
            ...
            redirect(base_url("backend/galleries/gallery_video_list/$gallery_id"));
