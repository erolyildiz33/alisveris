                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="footer-content">
                            <div class="logo-footer"><img id="logo_img"
                                     src="<?php echo get_picture("settings_v", $settings->logo, "300x70"); ?>"
                                     alt="<?php echo $settings->company_name; ?>"></div>
                            <p>
    ...
    <div class="subfooter">
        <div class="container">
            <div class="subfooter-inner">
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-center">Tüm Hakları Saklıdır © <?php echo date("Y"); ?> CMS by <a target="_blank" href="https://www.videosinif.com">VideoSınıf</a>. </p>
                    </div>
                </div>
            </div>
        </div>
