    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("backend/testimonials/update/$item->id"); ?>" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" placeholder="Bizimle ilgili mesaj..."
                                  cols="30" rows="10"><?php echo $item->description; ?></textarea>
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 image_upload_container">
                            <img src="<?php echo get_picture($viewFolderu, $item->img_url, "90x90"); ?>" alt=""
