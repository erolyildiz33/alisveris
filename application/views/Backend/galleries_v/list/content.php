<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            Galeri Listesi
            <a href="<?php echo base_url("backend/galleries/new_form"); ?>" class="btn btn-outline btn-primary btn-xs pull-right"> <i class="fa fa-plus"></i> Yeni Ekle</a>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
        <div class="widget p-lg">
            ...
            <?php if(empty($items)) { ?>
                ...
                <div class="alert alert-info text-center">
                    <p>Burada herhangi bir veri bulunmamaktadır. Eklemek için lütfen <a href="<?php echo base_url("backend/galleries/new_form"); ?>">tıklayınız</a></p>
                </div>
                            ...
                            <tr id="ord-<?php echo $item->id; ?>">
                                ...
                                <td class="text-center">
                                    <input data-csrf-value="<?=$this->security->get_csrf_hash();?>"
                                        data-url="<?php echo base_url("backend/galleries/isActiveSetter/$item->id"); ?>"
                                        class="isActive"
                                        type="checkbox"
                                        data-switchery
                                        data-color="#10c469"
                                ...
                                <td class="text-center">
                                    ...
                                    if($item->gallery_type == "image"){
                                        ...
                                        $button_url = "backend/galleries/upload_form/$item->id";

                                    } else if($item->gallery_type == "video") {

                                        $button_icon = "fa-play-circle-o";
                                        $button_url = "backend/galleries/gallery_video_list/$item->id";
                                    ...
                                    ?>
                                    <a href="<?php echo base_url("backend/galleries/update_form/$item->id"); ?>" class="btn btn-sm btn-info btn-outline"><i class="fa fa-pencil-square-o"></i> Düzenle</a>
