    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("backend/news/update/$item->id"); ?>" method="post"
                    ...
                    <?php if (isset($form_error)) { ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 image_upload_container">
                                <img src="<?php echo base_url("uploads/$viewFolderu/$item->img_url"); ?>" alt=""
                    ...
                    <?php } else { ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 image_upload_container">
                                <img src="<?php echo get_picture($viewFolderu, $item->img_url, "513x289"); ?>" alt=""
                                     class="img-responsive">
                            </div>
                    ...
                    <a href="<?php echo base_url("backend/news"); ?>" class="btn btn-md btn-danger btn-outline">İptal</a>
                </form>
            </div><!-- .widget-body -->
        </div><!-- .widget -->
    </div><!-- END column -->
