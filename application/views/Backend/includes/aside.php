...
<div class="menubar-scroll">
    <div class="menubar-scroll-inner">
        <ul class="app-menu">
            ...
            <?php if (isAllowedViewModule("product") && isAllowedViewModule("product_categories")) { ?>

                <li class="producthome has-submenu">
                    ...
                    <ul  class="submenu">
                        <li class="portfolio_categories">
                            <a href="<?php echo base_url("backend/product_categories"); ?>">
