<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            Portfolyo Listesi
            <a href="<?php echo base_url("backend/portfolio/new_form"); ?>"
        ...
        <div class="widget p-lg">
            ...
            <?php if (empty($items)) { ?>
                ...
                <div class="alert alert-info text-center">
                    <p>Burada herhangi bir veri bulunmamaktadır. Eklemek için lütfen <a
                                href="<?php echo base_url("backend/portfolio/new_form"); ?>">tıklayınız</a></p>
                </div>
            ...
            <?php } else { ?>
                ...
                <table class="table table-hover table-striped table-bordered content-container">
                    ...
                    <tbody class="sortable" data-url="<?php echo base_url("backend/portfolio/rankSetter"); ?>">
                    ...
                    <?php $i=1; foreach ($items as $item) { ?>
                        ...
                        <tr id="ord-<?php echo $item->id; ?>">
                            ...
                            <td class="text-center">
                                <input
                                        data-url="<?php echo base_url("backend/portfolio/isActiveSetter/$item->id"); ?>"
                                        class="isActive"
                                        type="checkbox"
                                        data-switchery
                                        data-color="#10c469"
                            ...
                            <td class="text-center w250">
                                <button
                                        data-url="<?php echo base_url("backend/portfolio/delete/$item->id"); ?>"
                                        class="btn btn-sm btn-danger btn-outline remove-btn" data-analiste="evet">
                                    <i class="fa fa-trash"></i> Sil
                                </button>
                                <a href="<?php echo base_url("backend/portfolio/update_form/$item->id"); ?>"
                                   class="btn btn-sm btn-info btn-outline"><i class="fa fa-pencil-square-o"></i> Düzenle</a>
                                <a href="<?php echo base_url("backend/portfolio/image_form/$item->id"); ?>"
