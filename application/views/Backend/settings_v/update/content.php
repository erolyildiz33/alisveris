<div class="row">
    ...
    <div class="col-md-12">
        <form action="<?php echo base_url("backend/settings/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="widget">
                <div class="widget-body">
                    ...
                    <a href="<?php echo base_url("backend/settings"); ?>" class="btn btn-md btn-danger">İptal</a>
                </div>
            </div>
