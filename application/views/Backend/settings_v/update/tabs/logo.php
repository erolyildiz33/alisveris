<div role="tabpanel" class="tab-pane fade" id="tab-7">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            ...
            <img
                src="<?php echo get_picture('settings_v', $item->logo, "150x35"); ?>"
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <img
                    src="<?php echo get_picture('settings_v', $item->mobile_logo, "300x70"); ?>"
                    alt="<?php echo $item->company_name; ?>"
                    class="img-responsive"
                    style="margin: 0px auto"
            >
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <img
                    src="<?php echo get_picture('settings_v', $item->favicon, "32x32"); ?>"
                    alt="<?php echo $item->company_name; ?>"
                    class="img-responsive"
                    style="margin: 0px auto"
            >
