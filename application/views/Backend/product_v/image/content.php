        ...
        <div class="widget">
            <div class="widget-body">
                <form  data-csrf-value="<?= $this->security->get_csrf_hash(); ?>"
                       ...
                       data-url="<?php echo base_url("backend/product/refresh_image_list/$item->id"); ?>"
                      action="<?php echo base_url("backend/product/image_upload/$item->id"); ?>" id="dropzone"
                      class="dropzone" data-plugin="dropzone"
                      data-options="{ url: '<?php echo base_url("backend/product/image_upload/$item->id"); ?>'}">
